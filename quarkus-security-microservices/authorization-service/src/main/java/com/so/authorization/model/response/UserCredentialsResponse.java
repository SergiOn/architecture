...
public final class UserCredentialsResponse {
    ...
    public static UserCredentialsResponse of(final UserCredentials createUserCredentials) {
        Objects.requireNonNull(createUserCredentials);
        return new UserCredentialsResponse(
                createUserCredentials.getToken(),
                createUserCredentials.getId(),
